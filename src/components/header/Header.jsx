...
const Header = ({ handleSidebarToggle }) => {
    ...
    return (
        <div className="header w-full h-14 flex sm:justify-end justify-between items-center py-4 px-6 bg-gray-900 text-white rounded-xl">
            {/* {selectItems.length} */}
            <button className="sm:hidden block  text-white focus:outline-none"
